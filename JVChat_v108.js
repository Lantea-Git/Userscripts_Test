            ...
            <div id='jvchat-info'>
                ...
                <div id='jvchat-topic'>
                    ...
                    <div id="jvchat-topic-info">
                        ...
                        <label id="jvchat-tabs" title="(Cloudflare /!\\) Ingore les onglets en arrière plan.">
                            <input id="jvchat-tabs-checkbox" type="checkbox">
                            <i></i>
                            <span id="jvchat-tabs-span">Ignorer Onglets <br> Inactifs (Cloudflare)</span>
                        </label>
                    </div>
                </div>
                <div id='jvchat-forum'>
            ...
            <div id='jvchat-config' class='jvchat-hide'>
                <div id='jvchat-configuration'>
                    ...
                    <div class="jvchat-config-option" id="jvchat-play-sound">
                        ...
                        <p>Joue un son de notification lorsqu'un nouveau message est posté et que vous êtes sur un onglet différent (ne marche pas avec l'option : Ignorer Onglets Inactifs).</p>
                    </div>
...
function clearPage(document) {
    ...
    document.getElementById("jvchat-tabs-checkbox").checked = configuration["no_inactive_tabs"];
    document.getElementById("jvchat-tabs-checkbox").addEventListener("change", tryCatch(toggleTabsOption));
    ...
    document.addEventListener("visibilitychange", function () {
        ...
        if (!document.hidden) {
            console.log("L'onglet est redevenu actif");
...
function toggleTabsOption(event) {
    let checked = document.getElementById("jvchat-tabs-checkbox").checked;
    configuration["no_inactive_tabs"] = checked;
    saveConfig();
}
...
function request(mode, url, callbackSuccess, callbackError, callbackTimeout, data, json, timeout, nocache) {
    ...
    if (document.hidden && configuration["no_inactive_tabs"]) {
