            ...
            <div id='jvchat-info'>
                ...
                <div id='jvchat-topic'>
                    ...
                    <div id="jvchat-topic-info">
                        ...
                        <label id="jvchat-tabs" title="(Cloudflare /!\\) Actualise les onglets en arrière plan.">
                            <input id="jvchat-tabs-checkbox" type="checkbox">
                            <i></i>
                            <span id="jvchat-tabs-span">Onglets Inactifs</span>
                        </label>
                    </div>
                </div>
                <div id='jvchat-forum'>
...
function clearPage(document) {
    ...
    document.getElementById("jvchat-tabs-checkbox").checked = configuration["inactive_tabs"];
...
function toggleTabsOption(event) {
    ...
    configuration["inactive_tabs"] = checked;
    saveConfig();
}
